...
Dog.create([{
    ...
    potty: 10, 
    adopted: false, 
    eat_gif: "https://media.giphy.com/media/ISneFKWJJesVIHQToy/giphy.gif", 
    ...
    drink_gif: "https://media.giphy.com/media/ISneFKWJJesVIHQToy/giphy.gif", 
    potty_gif: "https://media.giphy.com/media/ISneFKWJJesVIHQToy/giphy.gif",
    ...
    treats: Treat.all.filter{ |t| t.name != "salmon jerky" }},
    {
        ...
        walk_gif: "https://media.giphy.com/media/Ok1zcocGFPWcwMwcfN/giphy.gif", 
        jog_gif: "https://media.giphy.com/media/Ok1zcocGFPWcwMwcfN/giphy.gif", 
        drink_gif: "https://media.giphy.com/media/Ok1zcocGFPWcwMwcfN/giphy.gif", 
        ...
        nap_gif: "https://media.giphy.com/media/Ok1zcocGFPWcwMwcfN/giphy.gif",
        user_id: nil, 
        treats: Treat.all},
        {name: "MAVERICK", 
    hunger: 10, 
    ...
    walk_gif: "https://media.giphy.com/media/CE3SjWCpKTmWTqdT8p/giphy.gif", 
    jog_gif: "https://media.giphy.com/media/CE3SjWCpKTmWTqdT8p/giphy.gif", 
    potty_gif: "https://media.giphy.com/media/CE3SjWCpKTmWTqdT8p/giphy.gif",
    ...
    walk_gif: "https://media.giphy.com/media/YyLhbByS9BF97D1Eik/giphy.gif", 
    jog_gif: "https://media.giphy.com/media/YyLhbByS9BF97D1Eik/giphy.gif", 
    drink_gif: "https://media.giphy.com/media/7yrmx8Cz0hjboQykUZ/giphy.gif", 
    potty_gif: "https://media.giphy.com/media/YyLhbByS9BF97D1Eik/giphy.gif",
    pet_gif: "https://media.giphy.com/media/YyLhbByS9BF97D1Eik/giphy.gif", 
    treat_gif: "https://media.giphy.com/media/dKdHOVKm6eW0KxQ3ZS/giphy-downsized-large.gif", 
    nap_gif: "https://media.giphy.com/media/YyLhbByS9BF97D1Eik/giphy.gif",
    user_id: nil, 
